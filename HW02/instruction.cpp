...
bool Instruction::Execute(Memory* mem) {
	...
	switch (GetType()) {
		...
		case HLT:
			...
			break;
		case FORK:
			is_successful = ExecuteCallFork(mem);
			break;
		case PRN:
			is_successful = ExecuteCallPrn(mem);
			break;
		case EXEC:
			is_successful = ExecuteCallExec(mem);
			break;
		default:
			is_successful = ExecuteUndefined(mem);
			break;
...
bool Instruction::ExecuteCallFork(Memory* mem) {

}

bool Instruction::ExecuteCallPrn(Memory* mem) {

}

bool Instruction::ExecuteCallExec(Memory* mem) {
